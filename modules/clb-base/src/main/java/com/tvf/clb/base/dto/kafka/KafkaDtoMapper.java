...
public class KafkaDtoMapper {
    ...
    public static KafkaEntrantDto convertToKafkaEntrantDto(EntrantResponseDto entrant) {
        return KafkaEntrantDto.builder()
                ...
                .winDeduction(convertMapSiteIdToSiteName(entrant.getWinPriceDeductions()))
                .placeDeduction(convertMapSiteIdToSiteName(entrant.getPlacePriceDeductions()))
    ...
    public static KafkaEntrantDto convertToKafkaEntrantDto(Entrant entrant) {
        return KafkaEntrantDto.builder()
                ...
                .winDeduction(convertMapSiteIdToSiteName(CommonUtils.getPriceFromJsonb(entrant.getPriceWinDeductions())))
                .placeDeduction(convertMapSiteIdToSiteName(CommonUtils.getPriceFromJsonb(entrant.getPricePlaceDeductions())))
                .position(entrant.getPosition())
                .riderOrDriver(entrant.getRiderOrDriver())
                .trainerName(entrant.getTrainerName())
                .last6Starts(entrant.getLast6Starts())
